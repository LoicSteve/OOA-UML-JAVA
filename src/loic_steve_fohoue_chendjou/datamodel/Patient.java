package loic_steve_fohoue_chendjou.datamodel;
...
public class Patient {
    ...
    public Patient(String pat_num_HC, String pat_lastname, String pat_firstname) {
        this.pat_num_HC = pat_num_HC;
        this.pat_lastname = pat_lastname;
        this.pat_firstname = pat_firstname;
    }

    public Patient(String pat_num_HC, String pat_lastname, String pat_firstname, String pat_address, String pat_tel,
                   String pat_insurance_id, Date pat_sub_date) {
        this.pat_num_HC = pat_num_HC;
        this.pat_lastname = pat_lastname;
        this.pat_firstname = pat_firstname;
